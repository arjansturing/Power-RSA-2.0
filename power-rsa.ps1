...
# Function for creatinga TLS Crypt v2 Server key
Function createtav2server {
cls
banner
openvpn --genkey tls-crypt-v2-server $env:HOME\$env:KEY_DIR\v2crypt-server.key 
Start-Sleep 2
cls
Write-Host "TLS Crypt v2 Server key created" -ForeGroundColor Green
Write-Host "You can find the files in the following directory: $env:HOME\pki" -ForeGroundColor Green
Start-Sleep 5
}

# Function for creatinga TLS Crypt v2 Client key
Function createtav2client {
cls
banner
...
Start-Sleep 2
cls
Write-Host "TLS Crypt v2 Client key created" -ForeGroundColor Green
Write-Host "You can find the files in the following directory: $env:HOME\pki" -ForeGroundColor Green
Start-Sleep 5
}
...
Write-Host "4: Create TLS-Crypt v2 Server key"
Write-Host "5: Create TLS-Crypt v2 Client key"
Write-Host "6: Create Create Client Certificate without password"
Write-Host "7: Create Create Client Certificate with password"
